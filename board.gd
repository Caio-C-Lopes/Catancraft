...
# I'm colorblind, seems ok to me.
	...
	ResourceType.BRICK: Color(0.8, 0.2, 0.2),
	ResourceType.ORE: Color(0.5, 0.5, 0.5),
	ResourceType.DESERT: Color(0.93, 0.86, 0.51)
}
...
func create_hex(pos: Vector2, type: ResourceType, number: int):
	...
	if texture_to_use != null:
		...
		# sprite.scale = Vector2(0.5, 0.5) # For the future, when we get the sprites (Caio is gatekeeping it)
		...
		polygon.color = resource_colors[type]
